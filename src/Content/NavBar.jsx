...
const navItems = [
  ...
  { position: 18, title: "About" },
  { position: 30, title: "Work" },
  { position: 45, title: "Contact" },
];
...
const NavBar = () => {
  ...
  return (
    <motion.nav
      ...
      className="fixed left-0 top-0 z-100 flex h-screen flex-col items-end justify-between py-4 pl-8"
    >
